class DfbDomainKnowledge
  ...
  def i_know_normal_scrape_does_not_work
    resulting_array = ["2010 09 30 First Look Epcots New Karamell Kuche", "2013 01 15 Review Epcots Les Halles Bakery", "2013 09 04 First Look Starbucks Opens At Epcots Fountain View Cafe", "2013 05 29 First Look Lartisan Des Glaces Sorbet And Ice Cream Shop In Epcots France Is Open See Full Menu And Photos Here", "Disney Bar And Lounge Menu", "Team Spirits Pool Bar", "Amc Dine In Theater", "2014 01 21 News And Review The Smokehouse At House Of Blues Opens In Downtown Disney", "Splitsville Luxury Lanes", "Columbia Harbor House", "El Pirata Y El Perico", "Yakitori House", "Http   Disneyfoodblog Com Monsieur Paul Restaurant", "Kouzzina", "Siestas Pool Par", "On The Rocks Pool Bar", "Aunt Pollys", "Be Our Guest Restaurant", "Main Street Ice Cream Parlor", "Tomorrowland Terrace Cafe", "Tomorrowland Terrace Restaurant", "Westward Ho Refreshments", "Cool Wash Pizza", "Bistro De Paris", "Chefs De France", "La Cava Del Tequila", "Refreshment Cool Post", "Nine Dragons Restaurant", "Rose And Crown Pub", "Rose And Crown Pub And Dining Room", "Tutto Gusto", "Dawa Bar", "Dino Bite Snacks", "Drinkwallah", "Gardens Kiosk", "La Cantina De San Angel", "Harambe Fruit Market", "Kusafiri Coffee Shop And Bakery", "Tamu Tamu Refreshments", "Yak And Yeti Local Food Cafe", "Yak And Yeti Counter Service", "High Octane Refreshments", "The Trolley Car Cafe", "Tune In Lounge", "Silver Screen Spirits Pool Bar", "World Premiere Food Court", "Atlantic Dance Hall", "Jellyrolls Dueling Piano Bar", "Trattoria Al Forno 2", "California Grill Lounge", "San Angel Inn Restaurante", "Todd English Blue Zoo", "Bluezoo", "Beastly Kiosk", "Queen Victorias Room At Victoria And Alberts Restaurant", "The Gurgling Suitcase", "Trader Sams Tiki Terrace", "Garden Gallery", "Manginos", "Il Mulino New York Trattoria", "Trout Pass", "Dockside Margaritas", "Ghirardelli Soda Fountain Chocolate Fountain", "Ghirardelli Soda Fountain Chocolate Shop", "Ghirardelli Soda Fountain", "Erin Mckennas Bakery Nyc", "Akershus Royal Banquet Hall Princess Storybook Restaurant", "The Boathouse", "Downtown Disney Food Trucks", "Starbucks At Downtown Disney West Side"]
  end
