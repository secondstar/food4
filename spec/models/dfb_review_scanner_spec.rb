...
describe DfbReviewScanner do
  ...
  describe 'edge case grandstand-spirits-pool-bar' do
    # before do
    #   params = { path: "grandstand-spirits-pool-bar", yql_css_parse: '.entry-content'}
    #   @target = OpenStruct.new(params)
    #   # add nokogiri scrape of review to @target
    #   dh = DfbHarvester.new(@target)
    #   scraped_review_listing_page = dh.scrape_review_listing_page
  ...
  describe 'edge case amc-dine-in-theater' do
    # before do
    #   params = { path: "amc-dine-in-theater", yql_css_parse: '.entry-content'}
    #   @target = OpenStruct.new(params)
    #   # add nokogiri scrape of review to @target
    #   dh = DfbHarvester.new(@target)
    #   scraped_review_listing_page = dh.scrape_review_listing_page
    ...
    describe '#find_affinities' do
      ...
      # end
      #
      # it 'has a hash with the affinity for "Sci-Fi Dine In"' do
      #   subject.first['description'].must_equal "Sci-Fi Dine In"
      # end
  ...
  describe 'edge case monsieur-paul-restaurant' do
    # before do
    #   params = { path: "monsieur-paul-restaurant", yql_css_parse: '.entry-content'}
    #   @target = OpenStruct.new(params)
    #   # add nokogiri scrape of review to @target
    #   dh = DfbHarvester.new(@target)
    #   scraped_review_listing_page = dh.scrape_review_listing_page
  ...
  describe 'edge case bluezoo' do
    before do
      params = { path: "bluezoo", yql_css_parse: '.entry-content'}
      @target = OpenStruct.new(params)
      # add nokogiri scrape of review to @target
      dh = DfbHarvester.new(@target)
      scraped_review_listing_page = dh.scrape_review_listing_page
    ...
    describe '#find_tips' do
      ...
      it 'is an Array with a Hash as the first element' do
        subject.first.must_be_kind_of Hash
      end
    ...
    describe '#find_affinities' do
      ...
      it 'has a hash with the affinity for "Coral Reef Restaurant"' do
        subject.first['description'].must_equal "Coral Reef Restaurant"
      end
    ...
    describe '#find_bloggings' do
      ...
      it 'has ten elements in the array' do
        subject.length.must_equal 10
      end
